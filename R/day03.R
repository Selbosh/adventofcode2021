...
#' @rdname day03
#' @param x A data frame or matrix of binary integers
#' @return A single decimal integer
#' @export
power_consumption <- function(x) {
...
#'
#' @param x vector of binary digits
#' @return integer
...
#'
#' If 0 and 1 are equally common, 1 is returned (rounding up).
#'
#' @param x A matrix or data frame of binary integers
#' @return A binary vector of length `ncol(x)`
