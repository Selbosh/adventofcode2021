...
#' @rdname day05
#' @param x File or connection containing lines of the form `0,9 -> 5,9`
#' @return `read_segments`: a numeric matrix with four columns
#' @export
...
#' @rdname day05
#' @param lines Data frame of coordinates `x1`, `y1`, `x2`, `y2`
#' @param part2 Ignore diagonal lines?
#' @return `count_intersections`: number of points that fall on two or more line segments
#' @export
