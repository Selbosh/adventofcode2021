...
#' @rdname day20
#' @param x A binary (or logical) matrix.
#' @param pad Padding for elements around the edges. Defaults to 0.
binary_neighbours_to_int <- function(x, pad = 0) {
    I <- nrow(x)
    J <- ncol(x)
    . <- pad
...
#' @rdname day20
#' @param image A binary matrix.
#' @param algorithm A logical vector of length 512.
