...
#' @rdname day04
#' @param draws A numeric vector of numbers drawn
#' @param cards A matrix or data frame of bingo cards, stacked vertically
#' @return `play_bingo`, `play_bingo2`: The final score.
#' @export
