...
#' @rdname day18
#' @param input A character vector of strings describing nested arrays e.g. `[[1,2],3]`.
#' @return `read_sf`: A (possibly deeply) nested list of integers.
#' @export
...
#' @rdname day18
#' @param lst A (possibly deeply nested) list of pairs.
#' @export
